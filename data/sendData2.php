...
$ans =array("03","04","05","06","07","08","10","11","12","14","15","16","18","19","20","21","30","31");
...
$sql = "SELECT * FROM BINGO2 WHERE name = '{$user}'";
$res = $mysqli->query($sql);
if($res->num_rows >= 1){

    
    header( 'Location:http://l01l001.dothome.co.kr/bingo/helpmehelpmehelpmehelpmee2.html' );
    exit;
}
    
$sql="INSERT INTO BINGO2 (name, value, line) VALUES ('$user','$bingoValue','$line')";
$result = mysqli_query($mysqli,$sql);

if($result === false){
    echo mysqli_error($mysqli);
}
header( 'Location:http://l01l001.dothome.co.kr/bingo/helpmehelpmehelpmehelpme2.html' );
$mysqli->close();
