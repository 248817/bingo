...
if($res->num_rows >= 1){
    ...
    header( 'Location:http://l01l001.dothome.co.kr/bingo/helpmehelpmehelpmehelpmee.html' );
    exit;
}
...
header( 'Location:http://l01l001.dothome.co.kr/bingo/helpmehelpmehelpmehelpme.html' );
$mysqli->close();
